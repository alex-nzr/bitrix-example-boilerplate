...
use Vendor\Project\Dynamic\Agent\AgentManager;
use Vendor\Project\Dynamic\Internals\Control\EventManager as CbitEventManager;
use Vendor\Project\Dynamic\Internals\Control\ServiceManager;
use Vendor\Project\Dynamic\Internals\Installation\Installer;


Loc::loadMessages(__FILE__);

class vendor_project_dynamic extends CModule
{
    private CMain $App;
